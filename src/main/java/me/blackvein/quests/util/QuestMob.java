...
public class QuestMob {
    ...
    public void spawn() {
        ...
        for (int i = 0; i < spawnAmounts; i++) {
            ...
            final Entity entity = world.spawnEntity(spawnLocation, entityType);
            ...
            final EntityEquipment eq = ((CraftLivingEntity) entity).getEquipment();
    ...
    public boolean equals(Object o) {
        ...
        final QuestMob other = (QuestMob) o;

        if (name != null && other.name != null) {
            if (name.equalsIgnoreCase(other.name) == false) {
                return false;
            }
        } else if (name == null && other.name == null) {} else {
            return false;
        }
